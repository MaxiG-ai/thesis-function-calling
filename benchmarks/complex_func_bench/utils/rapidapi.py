...
class RapidAPICall:
    ...
    def observation_shorten(self, response):
        if isinstance(response, dict):
            keys_to_delete = [
                key for key, value in response.items() if (value in ["", None, {}, []])
            ]
...
if __name__ == "__main__":
    ...
    func_call = {
        ...
        "arguments": {
            "legs": [
                {"fromId": "ORD.AIRPORT", "toId": "HND.AIRPORT", "date": "2024-09-01"},
                {"fromId": "HND.AIRPORT", "toId": "PVG.AIRPORT", "date": "2024-09-05"},
                {"fromId": "PVG.AIRPORT", "toId": "ORD.AIRPORT", "date": "2024-09-10"},
            ]
        },
    }
